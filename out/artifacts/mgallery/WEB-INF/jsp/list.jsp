        ...
        function del(delObj) {
            ...
            Swal.fire({
                ...
                if (result.value == true) {
                    //alert("你点了'是'按钮")
                    $.ajax({
                        url: "/mgallery/management?method=delete&id=" + id,
                        type: "get",
                        dataType: "json",
...
<div class="container">
    <fieldset>
        ...
        <div style="height: 40px">
            <a href="/mgallery/management?method=show_create" class="btn-button">新增</a>
        </div>
        <!-- 油画列表 -->
            ...
            <c:forEach items="${pageModel.pageData }" var="painting">
                <tr>
                    ...
                    <td> <!-- 自定义用 data-preview data-pname	this就是指向这个超链接的本身 -->
                        ...
                        <a class="oplink" href="/mgallery/management?method=show_update&id=${painting.id}">修改</a>
                        <a class="oplink" href="javascript:void(0)" data-id="${painting.id }"
                           data-pname="${painting.pname }" data-preview="${painting.preview }"
        ...
        <ul class="page">
            ...
            <li><a href="/mgallery/management?method=list&p=${pageModel.hasPreviousPage?pageModel.page-1:1}">上页</a>
            </li>
            ...
            <li>
                <a href="/mgallery/management?method=list&p=${pageModel.hasNextPage?pageModel.page+1:pageModel.totalPages}">下页</a>
            </li>
